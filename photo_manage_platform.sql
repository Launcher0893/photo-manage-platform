...
INSERT INTO `forum_post` VALUES (4, 1, 5, '李的遗憾', '困住我青春的人始终没有回头看我', 45, 1, 1, 0, 1, '2026-05-15 13:54:27', '2026-05-15 13:54:27');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '帖子图片表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `forum_post_image` VALUES (11, 7, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/forum/eb5297d99cc74e8d9727d81e9f446a52.png', 'photo-manage-platform/forum/eb5297d99cc74e8d9727d81e9f446a52.png', 1, '2026-05-15 13:35:30');
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '摄影作品表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `photo_work` VALUES (4, '霸王', 3, 1, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/953b0bfcaefa4f6cb719374da201b4ab.jpg', '武汉', '今日我虽死，但我仍是霸王。', 9, 3, 2, 22, 1, 0, 1, '2026-05-14 09:33:30', '2026-05-15 13:31:14');
...
INSERT INTO `photo_work` VALUES (13, '四時之花', 6, 1, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/5f682c6185074cfbaa0411a21d41956d.jpg', '武汉', '风起时刻，四时花开', 34, 2, 0, 40, 1, 0, 1, '2026-05-15 11:07:16', '2026-05-15 13:32:59');
INSERT INTO `photo_work` VALUES (14, '再见，再见', 6, 1, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/1b67043ad8684c5d917254cba054ce96.jpg', '武汉', '我很欣赏你有独当一面的勇气，但是世界有太多定律我们无法改变，你吃饭了吗，我带你去吃饭吧', 41, 3, 0, 50, 1, 0, 1, '2026-05-15 11:15:20', '2026-05-15 13:52:08');
...
INSERT INTO `photo_work` VALUES (18, '☁', 5, 3, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/948dd54c84fa42b49ebf76c275c92e52.png', '武汉', 'None', 0, 0, 0, 0, 1, 0, 1, '2026-05-15 13:09:16', '2026-05-15 13:34:45');
INSERT INTO `photo_work` VALUES (19, '毕业季', 7, 1, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/1aee25965654461080fa9fc952bc5072.jpg', '武汉', '毕业季', 65, 1, 0, 68, 1, 0, 1, '2026-05-15 14:00:42', '2026-05-15 14:12:54');
INSERT INTO `photo_work` VALUES (20, '有狗我去', 7, 2, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/f5bbf67ac296424eb65316c52a3fda41.jpg', '武汉', '你的头上有只狗，还是异色边牧', 67, 2, 0, 73, 1, 0, 1, '2026-05-15 14:02:42', '2026-05-15 14:12:49');
INSERT INTO `photo_work` VALUES (21, '高质量人类', 7, 1, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/4df80795073e480faf7beb0dd2f4a545.jpg', '武汉', '666', 74, 2, 0, 80, 1, 0, 1, '2026-05-15 14:04:19', '2026-05-15 14:12:44');
INSERT INTO `photo_work` VALUES (22, '传奇肌肉男', 7, 4, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/9e99816b4a25498bb6176ea2f64396e5.jpg', '武汉', '刀刻般的肌肉', 154, 2, 3, 166, 1, 0, 1, '2026-05-15 14:05:03', '2026-05-15 14:13:05');
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作品组图表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `photo_work_image` VALUES (25, 18, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/87fe9caf9aeb4dfbaa7862586d5a75ac.png', 'photo-manage-platform/works/87fe9caf9aeb4dfbaa7862586d5a75ac.png', 1, '2026-05-15 13:34:51');
INSERT INTO `photo_work_image` VALUES (27, 20, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/works/340b8afca432407a8c1f1e08e6a066b3.jpg', 'photo-manage-platform/works/340b8afca432407a8c1f1e08e6a066b3.jpg', 2, '2026-05-15 14:02:43');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '摄影师认证资料表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `photographer` VALUES (7, 13, 'None', '成都', 1, 'nb', 1, '2026-05-15 13:59:40', '2026-05-15 13:59:40', '2026-05-15 13:59:40');
...
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统操作日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `system_log` VALUES (51, 1, '摄影师审核', '审核摄影师：Gemini1', '127.0.0.1', '2026-05-15 13:59:40');
...
INSERT INTO `user` VALUES (13, 'Gemini1', 'e10adc3949ba59abbe56e057f20f883e', 'gemini', NULL, NULL, 'https://photo-manage-oss.oss-cn-wuhan-lr.aliyuncs.com/photo-manage-platform/avatars/4666492961754fa99a6e900563c61c5f.jpg', 2, 1, '2026-05-15 13:57:56', '2026-05-15 13:57:56');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作品评论表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `work_comment` VALUES (7, 22, 13, 'zjf真帅', 1, 1, '2026-05-15 14:07:16', '2026-05-15 14:07:16');
INSERT INTO `work_comment` VALUES (8, 22, 5, '确实帅', 1, 1, '2026-05-15 14:10:17', '2026-05-15 14:10:17');
INSERT INTO `work_comment` VALUES (9, 22, 7, '一般我觉得', 1, 1, '2026-05-15 14:10:59', '2026-05-15 14:10:59');
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作品点赞表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `work_like` VALUES (24, 21, 13, '2026-05-15 14:08:40');
INSERT INTO `work_like` VALUES (25, 22, 13, '2026-05-15 14:08:49');
INSERT INTO `work_like` VALUES (26, 20, 13, '2026-05-15 14:08:53');
INSERT INTO `work_like` VALUES (27, 19, 13, '2026-05-15 14:08:56');
INSERT INTO `work_like` VALUES (28, 22, 7, '2026-05-15 14:11:19');
INSERT INTO `work_like` VALUES (29, 21, 7, '2026-05-15 14:11:31');
INSERT INTO `work_like` VALUES (30, 20, 7, '2026-05-15 14:11:35');
